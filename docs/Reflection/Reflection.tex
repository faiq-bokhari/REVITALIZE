...
System Design Changes: For the System Design, the following changes were done. The abbreviations and acronyms section was put in alphabetical order. Additionally, links to referenced documents were added. Also, subsections were added for the Figma design sketches which include an authentication section, a main page section, a diet section, an exercise section, and a sleep section.
