...
\begin{tabularx}{\textwidth}{p{3cm}p{2cm}X}
	...
	January 18th, 2023 & Youssef Dahab & Added Introduction section\\
	\bottomrule
\end{tabularx}
...
\begin{description}
	...
	\item[Services:]Visualizes calendar by dispaying interactive screen that shows current month and the respective days of the month, where user can click on desired day. Also has a backward and forward button to display previous and next month.
	\item[Implemented By:] REVITALIZE
\end{description}
