...
\begin{table}[H]
	\begin{center}
		...
		\begin{tabularx}{\textwidth}{cc|c|c|c|c|c|c|c|c|c|c|c|c|c|}
			...
			& & FR19  & FR20 & FR21 & FR22 & FR23  & FR24 & FR25-27 & FR28 & FR29 & FR31 \\ \cline{1-12}
			...
			\multicolumn{1}{|c| }{} 	                  &
			\multicolumn{1}{|c| }{ FR-DS-8} &&&&&&&&X&& \\ \cline{2-12}
			\multicolumn{1}{|c| }{} 	                  &
			\multicolumn{1}{|c| }{ FR-DS-9} &&&&&&&&&X& \\ \cline{2-12}
			\multicolumn{1}{|c| }{} 	                  &
			\multicolumn{1}{|c| }{ FR-DS-10} &&&&&&&&&&X \\ \cline{1-12}
		\end{tabularx}
	\end{center}
\end{table}
