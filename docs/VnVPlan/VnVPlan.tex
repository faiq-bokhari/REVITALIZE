...
\begin{tabularx}{\textwidth}{p{3cm}p{2cm}X}
	...
	November 1st, 2022 & Youssef Dahab & Added VnV Team\\
...
The REVITALIZE team's SRS verification plan is to have it reviewed by classmates, group members, course TA and professor. Classmates already adhocly reviewed REVITALIZE's SRS and provided their feedback. Furthermore, the course TA along with the professor will review REVITALIZE's SRS to provide more detailed and structured feedback. The REVITALIZE team members will meet together to gather all the feedback from classmates, course TA, and instructor. The team will then assess the feedback and analyze what can be incorporated. After that, the SRS will be refined and updated as part of the SRS verification process.
